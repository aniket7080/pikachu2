...
var charmander, charmanderGroup,charmander,charmander1,charmander2,charmander3;
var ostrich;
...
function preload(){
  ...
  //jumpSound = loadSound("Pikaaaa.mp3")
...
function setup(){
  ...
  background1.velocityX = -(5 + 5*score/50)
...
if(frameCount % 90 === 0){
  ...
  function spwanfood(){
    ...
    foodGroup.add(food);
    charmanderGroup.add(charmander);
